...
from app.Database.models import AdminRegistration
...
from app.utils.validation import validate_admin_registration
from app.utils.id_generator import generate_campus_id
